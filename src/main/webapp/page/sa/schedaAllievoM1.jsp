...
<%@page import="it.refill.domain.Condizione_Mercato"%>
...
<html>
    <head>
        <meta charset="utf-8" />
        <title>YES I Start Up - Donne e Disoccupati - Allievi</title>
                                                            ...
                                                            <div class="form-group form-group-sm row">
                                                                <div class="col-lg-10">
                                                                    ...
                                                                    <div class="form-row">
                                                                        ...
                                                                        <div class="form-group col-lg-4">
                                                                            <label>Target </label><label class="kt-font-danger kt-font-boldest">*</label>
                                                                            <input type="text" class="form-control" id="target" name="target" value="<%=a.getTarget()%>" readonly />
                                                                        </div>
                                                                    </div> 
                                                                </div>    
