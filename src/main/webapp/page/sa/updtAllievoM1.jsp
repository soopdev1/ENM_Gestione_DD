...
<%@page import="it.refill.domain.Condizione_Lavorativa"%>
<%@page import="it.refill.domain.Comuni"%>
<%@page import="java.util.Date"%>
<%@page import="java.text.DateFormat"%>
<%@page import="it.refill.domain.Allievi"%>
<%@page import="it.refill.db.Action"%>
<%@page import="it.refill.domain.TitoliStudio"%>
...
<%
    ...
    if (us == null) {
        ...
        if (!Action.isVisibile(String.valueOf(us.getTipo()), pageName_)) {
            ...
            List<Item> targets = Utility.listTargets();
            Entity e = new Entity();
...
<html>
    <head>
        <meta charset="utf-8" />
        <title>YES I Start Up - NEET - Allievi</title>
                        ...
                        <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
                            <div class="kt-portlet kt-portlet--mobile">
                                <div class="kt-portlet__body">
                                    ...
                                    <div class="kt-portlet__body">
                                        <form class="kt-form" id="kt_form" action="<%=request.getContextPath()%>/OperazioniSA?type=upAllievoM1" style="padding-top: 0;"  method="post" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="form-group col-xl-3 col-lg-6">
                                                                            ...
                                                                            <div class="dropdown bootstrap-select form-control kt-" id="cittadinanza_div" style="padding: 0;">
                                                                                <select class="form-control kt-select2-general obbligatory" id="cittadinanza" name="cittadinanza"  style="width: 100%">
                                                                                    ...
                                                                                    <%for (Nazioni_rc cit : cittadinanza) {
                                                                                            if (cit.getId() == a.getCittadinanza().getId()) {%>
                                                                                    <option value="<%=cit.getId()%>" selected><%=cit.getNome()%></option>
                                                                                    <%} else {%>
                                                                                    <option value="<%=cit.getId()%>"><%=cit.getNome()%></option>
                                                                                    <%}
                                                                                        }%>
                                                                                </select>
                                                                            </div>
                                                                    ...
                                                                    <div class="form-row">
                                                                        <div class="form-group col-lg-4">
                                                                            ...
                                                                            <div class="dropdown bootstrap-select form-control kt-" id="target_div" style="padding: 0;">
                                                                                <select class="form-control kt-select2-general obbligatory" id="target" name="target"  style="width: 100%">
                                                                                    <option value="-">Seleziona target</option>
                                                                                    <%for (Item c : targets) {
                                                                                            if (c.getCod().equals(a.getTarget())) {%>
                                                                                    <option value="<%=c.getCod()%>" selected><%=c.getDescrizione()%></option>
                                                                                    <%} else {%>
                                                                                    <option value="<%=c.getCod()%>"><%=c.getDescrizione()%></option>
                                                                                    <%}
                                                                                        }%>
                                                                                </select>
                                                                            </div>
