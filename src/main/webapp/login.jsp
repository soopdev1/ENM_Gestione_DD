...
<html>
    ...
    <head>
        <meta charset="utf-8" />
        <title>YES I Start Up - Donne e Disoccupati</title>
                    ...
                    <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
                        <div class="kt-login__container">
                            <div class="kt-login__logo">
                                <img src="assets/media/logos/l3-cu.png" alt="" height="40px"/>
                                <img src="assets/media/logos/spao.jpg" alt="" height="40px"/>
                                <img src="assets/media/logos/l1-an.png" alt="" height="40px"/>
                                <img src="assets/media/logos/se.png" alt="" height="40px"/>
                            </div>
                            <hr>
                            ...
                            <hr>
                            <div class="kt-login__head">
                                <div class="kt-login__title uppercase"><i><small>TARGET: DONNE INATTIVE / DISOCCUPATI DI LUNGA DURATA</small></i></div>
                            </div>
                            <hr>
