...
import it.refill.domain.Pagina;
import it.refill.domain.Path;
...
//        }
    ...
    public List<Allievi> getAllievi(SoggettiAttuatori sa, String nome, String cognome, String cf) {
        HashMap<String, Object> param = new HashMap<>();
